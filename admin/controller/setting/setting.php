...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_social_line'])) {
			$data['config_social_line'] = $this->request->post['config_social_line'];
		} else {
			$data['config_social_line'] = $this->config->get('config_social_line');
		}

		if (isset($this->request->post['config_social_pan_facebook'])) {
			$data['config_social_pan_facebook'] = $this->request->post['config_social_pan_facebook'];
		} else {
			$data['config_social_pan_facebook'] = $this->config->get('config_social_pan_facebook');
		}
		if (isset($this->request->post['config_social_pan_instagram'])) {
			$data['config_social_pan_instagram'] = $this->request->post['config_social_pan_instagram'];
		} else {
			$data['config_social_pan_instagram'] = $this->config->get('config_social_pan_instagram');
		}
		if (isset($this->request->post['config_social_pan_youtube'])) {
			$data['config_social_pan_youtube'] = $this->request->post['config_social_pan_youtube'];
		} else {
			$data['config_social_pan_youtube'] = $this->config->get('config_social_pan_youtube');
		}
		if (isset($this->request->post['config_social_pan_google'])) {
			$data['config_social_pan_google'] = $this->request->post['config_social_pan_google'];
		} else {
			$data['config_social_pan_google'] = $this->config->get('config_social_pan_google');
		}
		if (isset($this->request->post['config_social_pan_twitter'])) {
			$data['config_social_pan_twitter'] = $this->request->post['config_social_pan_twitter'];
		} else {
			$data['config_social_pan_twitter'] = $this->config->get('config_social_pan_twitter');
		}
		if (isset($this->request->post['config_social_pan_line'])) {
			$data['config_social_pan_line'] = $this->request->post['config_social_pan_line'];
		} else {
		...
		foreach ($categories as $category) {
			if ($category['parent_id'] == 0) {
				...
				if (isset($this->request->post['config_social_facebook_'.$category['name']])) {
					$data['config_social_facebook_brand'][$category['name']] = $this->request->post['config_social_facebook_'.$category['name']];
				} else {
					$data['config_social_facebook_brand'][$category['name']] = $this->config->get('config_social_facebook_'.$category['name']);
				}

				if (isset($this->request->post['config_social_instagram_'.$category['name']])) {
					$data['config_social_instagram_brand'][$category['name']] = $this->request->post['config_social_instagram_'.$category['name']];
				} else {
					$data['config_social_instagram_brand'][$category['name']] = $this->config->get('config_social_instagram_'.$category['name']);
				}

				if (isset($this->request->post['config_social_youtube_'.$category['name']])) {
					$data['config_social_youtube_brand'][$category['name']] = $this->request->post['config_social_youtube_'.$category['name']];
				} else {
					$data['config_social_youtube_brand'][$category['name']] = $this->config->get('config_social_youtube_'.$category['name']);
				}

				if (isset($this->request->post['config_social_google_'.$category['name']])) {
					$data['config_social_google_brand'][$category['name']] = $this->request->post['config_social_google_'.$category['name']];
				} else {
					$data['config_social_google_brand'][$category['name']] = $this->config->get('config_social_facebook_'.$category['name']);
				}

				if (isset($this->request->post['config_social_twitter_'.$category['name']])) {
					$data['config_social_twitter_brand'][$category['name']] = $this->request->post['config_social_twitter_'.$category['name']];
				} else {
					$data['config_social_twitter_brand'][$category['name']] = $this->config->get('config_social_twitter_'.$category['name']);
				}

				if (isset($this->request->post['config_social_line_'.$category['name']])) {
					$data['config_social_line_brand'][$category['name']] = $this->request->post['config_social_line_'.$category['name']];
				} else {
					$data['config_social_line_brand'][$category['name']] = $this->config->get('config_social_line_'.$category['name']);
				}
			}
		}
