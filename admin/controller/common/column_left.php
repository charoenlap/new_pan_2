...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			$data['banner_home'] = $this->url->link('design/banner/edit', 'user_token=' . $this->session->data['user_token'] . '&banner_id=25', true);
			$data['cate_home'] = $this->url->link('extension/module/home_category&', 'user_token=' . $this->session->data['user_token'] . '&module_id=36', true);
			$data['featured_home'] = $this->url->link('extension/module/featured&', 'user_token=' . $this->session->data['user_token'] . '&module_id=39', true);
