...
define('HTTP_SERVER', 'https://www.sportstown-online.com/kappa_thailand/');

// HTTPS
define('HTTPS_SERVER_MAIN', 'https://www.sportstown-online.com/');
define('HTTPS_SERVER', 'https://www.sportstown-online.com/kappa_thailand/');

// DIR
define('DIR_APPLICATION', '/var/www/vhosts/sportstown-online.com/httpdocs/kappa_thailand/catalog/');
...
define('DIR_MODIFICATION', DIR_STORAGE . 'modification/kappa_thailand/');
