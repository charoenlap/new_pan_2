          ...
          <div class="blog-listing">
            <div class="row">
              <div class="col-lg-6 col-xs-12">
                <div class="blog-item">
                  <div class="blog-media mb-30">
                    <img src="images/blog_img1.jpg" alt="Eshoper">
                    <a href="single-blog.php" title="Click For Read More" class="read">&nbsp;</a> 
                  </div>
                  <div class="blog-detail">
                    <span class="post-date">01 jan 2017</span>
                    <h3><a href="single-blog.php">Combined with a handful of model</a></h3>
              ...
              <div class="col-lg-6 col-xs-12">
                <div class="blog-item">
                  <div class="blog-media mb-30">
                    <img src="images/blog_img2.jpg" alt="Eshoper">
                    <a href="single-blog.php" title="Click For Read More" class="read">&nbsp;</a> 
                  </div>
                  <div class="blog-detail">
              ...
              <div class="col-lg-6 col-xs-12">
                <div class="blog-item">
                  <div class="blog-media mb-30">
                    <img src="images/blog_img3.jpg" alt="Eshoper">
                    <a href="single-blog.php" title="Click For Read More" class="read">&nbsp;</a> 
                  </div>
                  <div class="blog-detail">
              ...
              <div class="col-lg-6 col-xs-12">
                <div class="blog-item">
                  <div class="blog-media mb-30">
                    <img src="images/blog_img4.jpg" alt="Eshoper">
                    <a href="single-blog.php" title="Click For Read More" class="read">&nbsp;</a> 
                  </div>
                  <div class="blog-detail">
                    <span class="post-date">02 jan 2017</span>
