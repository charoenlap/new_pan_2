  ...
  <section class="ptb-95">
    <div class="container">
                ...
                <tbody>
                  <tr>
                    <td><a href="product-page.php">
                      <div class="product-image"><img alt="Eshoper" src="images/1.jpg"></div>
                      </a></td>
                    <td><div class="product-title"> <a href="product-page.php">Cross Colours Camo Print Tank half mengo</a> </div></td>
                    <td><ul>
                        <li>
                  ...
                  <tr>
                    <td><a href="product-page.php">
                      <div class="product-image"><img alt="Eshoper" src="images/2.jpg"></div>
                      </a></td>
                    <td><div class="product-title"> <a href="product-page.php">Defyant Reversible Dot Shorts</a> </div></td>
                    <td><ul>
                        <li>
                          <div class="base-price price-box"> <span class="price">$80.00</span> </div>
                        </li>
      ...
      <div class="mb-30">
        <div class="row">
          <div class="col-sm-6">
            <div class="mt-30"> <a href="shop.php" class="btn-color btn"><span><i class="fa fa-angle-left"></i></span>Continue Shopping</a> </div>
          </div>
          <div class="col-sm-6">
      ...
      <div class="mt-30">
        <div class="row">
          <div class="col-xs-12">
            <div class="right-side float-none-xs"> <a href="checkout.php" class="btn-color btn">Proceed to checkout<span><i class="fa fa-angle-right"></i></span></a> </div>
          </div>
        </div>
      </div>
    </div>
