      ...
      <div class="row">
          ...
          <div class="row">
            <div class="col-md-5 col-sm-5 mb-xs-30">
              	<!-- <div class="fotorama" data-nav="thumbs" data-allowfullscreen="native"> 
	          		<a href="#"><img src="images/1.jpg" alt="Eshoper"></a> 
	          		<a href="#"><img src="images/2.jpg" alt="Eshoper"></a> 
	          		<a href="#"><img src="images/3.jpg" alt="Eshoper"></a> 
	          		<a href="#"><img src="images/4.jpg" alt="Eshoper"></a> 
	          		<a href="#"><img src="images/5.jpg" alt="Eshoper"></a> 
	          		<a href="#"><img src="images/6.jpg" alt="Eshoper"></a> 
	          		<a href="#"><img src="images/4.jpg" alt="Eshoper"></a> 
	          		<a href="#"><img src="images/5.jpg" alt="Eshoper"></a> 
	          		<a href="#"><img src="images/6.jpg" alt="Eshoper"></a> 
          		</div> -->
              <div class="row">
                    <div class="product-item-holder size-big single-product-gallery small-gallery">
                        ...
                        <div class="product_gallery">
                            ...
                            <figure>
                                <a class="horizontal-thumb" href="#slide5">
                                  <img alt="" src="images/5.jpg" />
                                </a>
                            </figure>
                            <figure>
                                <a class="horizontal-thumb" href="#slide6">
                                  <img alt="" src="images/6.jpg" />
                                </a>
                            </figure>
                        </div>
                        ...
                        <div class="bottom-detail cart-button">
                          <ul>
                            <li class="pro-cart-icon">
                              <form>
                                <button title="Add to Cart" class="btn-color btn"><span></span>Add to Cart</button>
                              </form>
                            </li>
                          </ul>
                        </div>
        ...
        <div class="col-md-3">
          <!-- <div class="brand-logo-pro align-center mb-30">
            <img src="images/brand5.png" alt="Eshoper">
          </div> -->
          <div class="sub-banner-block align-center">
            <img src="images/cate_3.jpg" alt="Eshoper">
          </div>
        </div>
      </div>
    </div>
                    ...
                    <div class="items-Reviews">
                      <div class="comments-area">
                        ...
                        <ul class="comment-list mt-30">
                          <li>
                            <div class="comment-user"> <img src="images/comment-user.jpg" alt="Eshoper"> </div>
          ...
          <div class="pro_cat">
            <div class="owl-carousel pro_cat_slider">
              ...
              <div class="item">
                <div class="product-item">
                  <div class="sale-label"><span>Sale</span></div>
                  <div class="product-image"> <a href="product-page.php"> <img src="images/6.jpg" alt=""> </a>
                    <div class="product-detail-inner">
                      <div class="detail-inner-left left-side">
                        <ul>
                          <li class="pro-cart-icon">
