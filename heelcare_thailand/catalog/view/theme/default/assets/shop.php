        ...
        <div class="col-lg-2 col-md-3 mb-sm-30 sidebar-col">
          <div class="sidebar-block">
            ...
            <div class="sidebar-box mb-40 visible-md visible-lg"> 
              <a href="#"> 
                <img src="images/cate_1.jpg" alt="Eshoper"> 
              </a> 
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="view">
                  ...
                  <div class="list-types list"> <a href="shop-list.php">
              ...
              <div class="row mlr_-20">
                <div class="col-md-4 col-xs-6 plr-20 mb-30">
                  <div class="product-item">
                    <div class="product-image"> <a href="product-page.php"> <img src="images/1.jpg" alt=""> </a>
                ...
                <div class="col-md-4 col-xs-6 plr-20 mb-30">
                  <div class="product-item">
                    ...
                    <div class="product-image"> <a href="product-page.php"> <img src="images/2.jpg" alt=""> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left left-side">
                          <ul>
                            <li class="pro-cart-icon">
                ...
                <div class="col-md-4 col-xs-6 plr-20 mb-30">
                  <div class="product-item">
                    ...
                    <div class="product-image"> <a href="product-page.php"> <img src="images/14.jpg" alt=""> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left left-side">
                          <ul>
                            <li class="pro-cart-icon">
                ...
                <div class="col-md-4 col-xs-6 plr-20 mb-30">
                  <div class="product-item">
                    <div class="product-image"> <a href="product-page.php"> <img src="images/3.jpg" alt=""> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left left-side">
                          <ul>
                            <li class="pro-cart-icon">
                ...
                <div class="col-md-4 col-xs-6 plr-20 mb-30">
                  <div class="product-item">
                    <div class="sale-label"><span>Sale</span></div>
                    <div class="product-image"> <a href="product-page.php"> <img src="images/13.jpg" alt=""> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left left-side">
                          <ul>
                            <li class="pro-cart-icon">
                ...
                <div class="col-md-4 col-xs-6 plr-20 mb-30">
                  <div class="product-item">
                    <div class="product-image"> <a href="product-page.php"> <img src="images/15.jpg" alt=""> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left left-side">
                          <ul>
                            <li class="pro-cart-icon">
                ...
                <div class="col-md-4 col-xs-6 plr-20 mb-30">
                  <div class="product-item">
                    <div class="product-image"> <a href="product-page.php"> <img src="images/4.jpg" alt=""> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left left-side">
                          <ul>
                            <li class="pro-cart-icon">
                ...
                <div class="col-md-4 col-xs-6 plr-20 mb-30">
                  <div class="product-item">
                    <div class="sale-label"><span>Sale</span></div>
                    <div class="product-image"> <a href="product-page.php"> <img src="images/5.jpg" alt=""> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left left-side">
                          <ul>
                            <li class="pro-cart-icon">
                ...
                <div class="col-md-4 col-xs-6 plr-20 mb-30">
                  <div class="product-item">
                    <div class="new-label"><span>New</span></div>
                    <div class="product-image"> <a href="product-page.php"> <img src="images/8.jpg" alt=""> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left left-side">
                          <ul>
                            <li class="pro-cart-icon">
                ...
                <div class="col-md-4 col-xs-6 plr-20 mb-30">
                  <div class="product-item">
                    <div class="new-label"><span>New</span></div>
                    <div class="sale-label"><span>Sale</span></div>
                    <div class="product-image"> <a href="product-page.php"> <img src="images/16.jpg" alt=""> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left left-side">
                          <ul>
                            <li class="pro-cart-icon">
                ...
                <div class="col-md-4 col-xs-6 plr-20 mb-30">
                  <div class="product-item">
                    <div class="product-image"> <a href="product-page.php"> <img src="images/7.jpg" alt=""> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left left-side">
                          <ul>
                            <li class="pro-cart-icon">
                ...
                <div class="col-md-4 col-xs-6 plr-20 mb-30">
                  <div class="product-item">
                    <div class="product-image"> <a href="product-page.php"> <img src="images/12.jpg" alt=""> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left left-side">
                          <ul>
                            <li class="pro-cart-icon">
                ...
                <div class="col-md-4 col-xs-6 plr-20 mb-30">
                  <div class="product-item">
                    <div class="product-image"> <a href="product-page.php"> <img src="images/9.jpg" alt=""> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left left-side">
                          <ul>
                            <li class="pro-cart-icon">
