          ...
          <div class="product-listing list-type">
            <div class="row">
              <div class="col-lg-6 col-xs-12">
                <div class="shop-list-view">
                  <div class="product-item">
                    ...
                    <div class="product-image"> <a href="product-page.php"> <img src="images/1.jpg" alt=""> </a> </div>
                  </div>
              ...
              <div class="col-lg-6 col-xs-12">
                <div class="shop-list-view">
                  <div class="product-item">
                    <div class="product-image"> <a href="product-page.php"> <img src="images/2.jpg" alt=""> </a> </div>
                  </div>
                  <div class="product-item-details">
              ...
              <div class="col-lg-6 col-xs-12">
                <div class="shop-list-view">
                  <div class="product-item">
                    <div class="product-image"> <a href="product-page.php"> <img src="images/3.jpg" alt=""> </a> </div>
                  </div>
                  <div class="product-item-details">
                    <div class="product-item-name"> <a href="product-page.php">Cross Colours Camo Print</a> </div>
                    <div class="rating-summary-block">
              ...
              <div class="col-lg-6 col-xs-12">
                <div class="shop-list-view">
                  <div class="product-item">
                    <div class="product-image"> <a href="product-page.php"> <img src="images/4.jpg" alt=""> </a> </div>
                  </div>
                  <div class="product-item-details">
                    <div class="product-item-name"> <a href="product-page.php">Cross Colours Camo Print</a> </div>
                    <div class="rating-summary-block">
              ...
              <div class="col-lg-6 col-xs-12">
                <div class="shop-list-view">
                  <div class="product-item">
                    <div class="product-image"> <a href="product-page.php"> <img src="images/5.jpg" alt=""> </a> </div>
                  </div>
                  <div class="product-item-details">
                    <div class="product-item-name"> <a href="product-page.php">Cross Colours Camo Print</a> </div>
                    <div class="rating-summary-block">
