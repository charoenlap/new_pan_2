...
//Rating Star activator
    if ($('.star').length > 0) {
      $('.star').raty({
        space: false,
        starOff: 'catalog/view/theme/default/assets/images/star-off.png',
        starOn: 'catalog/view/theme/default/assets/images/star-on.png',
        score: function () {
...
jQuery(document).ready(function($) {
  $('.mainCategoryHover').mousedown(function(event) {
    console.log('ko');
    $(this).children('.subproduct').addClass('active');
  });
  $('.mainCategoryHover a').hover(function() {
    console.log('ko');
    $(this).children('.subproduct').addClass('active');
  }, function() {
    $(this).children('.subproduct').removeClass('active');
  });
});
